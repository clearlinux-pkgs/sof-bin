...
Source0  : https://github.com/thesofproject/sof-bin/releases/download/v2024.06/sof-bin-2024.06.tar.gz
...
%prep
%setup -q -n sof-bin-2024.06
cd %{_builddir}/sof-bin-2024.06
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1721331374
