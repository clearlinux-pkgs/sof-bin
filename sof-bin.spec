...
Version  : 1.8
Release  : 6
URL      : https://github.com/thesofproject/sof-bin/archive/v1.8/sof-bin-1.8.tar.gz
Source0  : https://github.com/thesofproject/sof-bin/archive/v1.8/sof-bin-1.8.tar.gz
...
%prep
%setup -q -n sof-bin-1.8
cd %{_builddir}/sof-bin-1.8
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1624380890
...
cp %{_builddir}/sof-bin-1.8/LICENCE.Intel %{buildroot}/usr/share/package-licenses/sof-bin/b052da06a67e96a1d3ca22f4630bf7956ea88d5a
cp %{_builddir}/sof-bin-1.8/LICENCE.NXP %{buildroot}/usr/share/package-licenses/sof-bin/b428069e1aa2a6a89fc188a63dc40e861236a2e2
%make_install SOF_VERSION=%{version}

%files
%defattr(-,root,root,-)
/usr/lib/firmware/intel/sof-tplg/sof-adl-rt1316-l2-mono-rt714-link0.tplg
