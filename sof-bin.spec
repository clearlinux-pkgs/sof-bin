...
Version  : 2.1.1
Release  : 8
URL      : https://github.com/thesofproject/sof-bin/archive/v2.1.1/sof-bin-2.1.1.tar.gz
Source0  : https://github.com/thesofproject/sof-bin/archive/v2.1.1/sof-bin-2.1.1.tar.gz
...
%prep
%setup -q -n sof-bin-2.1.1
cd %{_builddir}/sof-bin-2.1.1
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654032455
...
cp %{_builddir}/sof-bin-2.1.1/LICENCE.Intel %{buildroot}/usr/share/package-licenses/sof-bin/b052da06a67e96a1d3ca22f4630bf7956ea88d5a
cp %{_builddir}/sof-bin-2.1.1/LICENCE.NXP %{buildroot}/usr/share/package-licenses/sof-bin/b428069e1aa2a6a89fc188a63dc40e861236a2e2
...
/usr/lib/firmware/intel/sof/community/sof-apl-zephyr.ldc
/usr/lib/firmware/intel/sof/community/sof-apl.ri
/usr/lib/firmware/intel/sof/community/sof-cfl-zephyr.ldc
/usr/lib/firmware/intel/sof/community/sof-cfl.ri
/usr/lib/firmware/intel/sof/community/sof-cml-zephyr.ldc
/usr/lib/firmware/intel/sof/community/sof-cml.ri
/usr/lib/firmware/intel/sof/community/sof-cnl-zephyr.ldc
