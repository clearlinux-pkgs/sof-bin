...
Source0  : https://github.com/thesofproject/sof-bin/releases/download/v2024.09.2/sof-bin-2024.09.2.tar.gz
...
%prep
%setup -q -n sof-bin-2024.09.2
cd %{_builddir}/sof-bin-2024.09.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1735114935
