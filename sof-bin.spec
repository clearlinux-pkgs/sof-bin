...
Version  : 2.2
Release  : 9
URL      : https://github.com/thesofproject/sof-bin/archive/v2.2/sof-bin-2.2.tar.gz
Source0  : https://github.com/thesofproject/sof-bin/archive/v2.2/sof-bin-2.2.tar.gz
...
%prep
%setup -q -n sof-bin-2.2
cd %{_builddir}/sof-bin-2.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656697451
...
cp %{_builddir}/sof-bin-2.2/LICENCE.Intel %{buildroot}/usr/share/package-licenses/sof-bin/b052da06a67e96a1d3ca22f4630bf7956ea88d5a
cp %{_builddir}/sof-bin-2.2/LICENCE.NXP %{buildroot}/usr/share/package-licenses/sof-bin/b428069e1aa2a6a89fc188a63dc40e861236a2e2
