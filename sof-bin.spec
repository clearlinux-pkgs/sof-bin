...
Source0  : https://github.com/thesofproject/sof-bin/releases/download/v2024.09.1/sof-bin-2024.09.1.tar.gz
...
%prep
%setup -q -n sof-bin-2024.09.1
cd %{_builddir}/sof-bin-2024.09.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1731088257
